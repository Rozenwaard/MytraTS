        ...
        {user && (
          <div className="navbar-center flex gap-1">
            ...
            {user.role === "администратор" && (
              <Link to="/reports" className="btn btn-ghost btn-sm" activeProps={{ className: "btn-active" }}>
                Отчёты
              </Link>
            )}
        ...
        <div className="navbar-end flex items-center gap-2">
          {user ? (
            <>
              ...
              <button onClick={toggle} className="btn btn-ghost btn-sm" title="Переключить тему">
                {theme === "autumn" ? (
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-warning"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                ) : (
